...
public class HalbSneakHalbEllujäämine {
    public void esimeneInfoMängijaleHalbSneakHalbEllujäämine() throws IOException {
    ...
    public int esimenePeatükkHalbSneakHaalbEllujäämine(List<String> asjad) throws IOException {
